...
def main():
    ...
    with subprocess.Popen(
        ["ffmpeg", "-y", "-i", "temp/result.avi", "-i", "-",
        "-c:v", "libx264", "-c:a", "aac", "-strict", "experimental", "output.mp4"],
        stdin=subprocess.PIPE
    ) as proc:
        # Write the binary audio data to the stdin of ffmpeg process
        proc.stdin.write(mel_chunks)
